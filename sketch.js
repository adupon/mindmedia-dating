...
function preload() {
  thumbupflat=loadImage("thumbsup-flat.png");
  thumbupshadow=loadImage("thumbsup-shadow.png");
  thumbdownflat=loadImage("thumbsdown-flat.png");
  thumbdownshadow=loadImage("thumbsdown-shadow.png");
  avatarLogo=loadImage('avatarLogo.png');
